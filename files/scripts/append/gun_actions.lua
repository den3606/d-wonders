...
local original_actions = {{
  ...
  spawn_probability = "0.3,0.3,0.6,0.7,1",
  price = 180,
  mana = 130,
  max_uses = 5,
  never_unlimited = true,
  ...
  type = ACTION_TYPE_PROJECTILE,
  spawn_level = "2,3,4,5,6",
  spawn_probability = "0.5,0.6,0.7,0.8,1",
  price = 150,
  mana = 20,
  custom_xml_file = "mods/d-wonders/files/entities/misc/custom_cards/liquid_shot.xml",
  action = function()
  ...
  type = ACTION_TYPE_PROJECTILE,
  spawn_level = "2,4,5,6",
  spawn_probability = "0.1,0.1,0.6,1",
  price = 200,
  mana = 10,
  max_uses = 10,
  never_unlimited = true,
  ...
  type = ACTION_TYPE_PROJECTILE,
  spawn_level = "2,3,5,6",
  spawn_probability = "0.3,0.3,0.8,1",
  price = 170,
  mana = 30,
  custom_xml_file = "mods/d-wonders/files/entities/misc/custom_cards/liquid_shot.xml",
  action = function()
  ...
  type = ACTION_TYPE_PROJECTILE,
  spawn_level = "1,2,3,4",
  spawn_probability = "0.5,0.8,0.8,1",
  price = 140,
  mana = 10,
  custom_xml_file = "mods/d-wonders/files/entities/misc/custom_cards/liquid_shot.xml",
  action = function()
  ...
  type = ACTION_TYPE_PROJECTILE,
  spawn_level = "2,3,4,5",
  spawn_probability = "0.5,0.6,0.7,0.8",
  price = 150,
  mana = 20,
  custom_xml_file = "mods/d-wonders/files/entities/misc/custom_cards/liquid_shot.xml",
  action = function()
