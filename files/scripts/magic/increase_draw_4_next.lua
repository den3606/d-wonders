...
local function increase_actions_per_round(spell_entity_id, wand_entity_id, ability_component)
  EntityAddTag(spell_entity_id, 'enabled_increase_draw_4')

  local true_actions_per_round = GetInternalVariableValue(wand_entity_id, 'increase_draw_decrease_draw.true_actions_per_round', 'value_int')
  if true_actions_per_round == nil then
    ...
    AddNewInternalVariable(wand_entity_id, 'increase_draw_decrease_draw.true_actions_per_round', 'value_int', true_actions_per_round)
  end

  local new_actions_per_round = true_actions_per_round + INCREASE_DRAW_SIZE
  SetInternalVariableValue(wand_entity_id, "increase_draw_decrease_draw.true_actions_per_round", "value_int", new_actions_per_round)
...
local function decrease_actions_per_round(spell_entity_id, wand_entity_id, ability_component)
  EntityRemoveTag(spell_entity_id, 'enabled_increase_draw_4')

  RemoveInternalVariableValue(spell_entity_id, 'increase_draw_4.target_wand_entity_id')
...
local function when_wand_got_increase_draw(spell_entity_id)
  local wand_entity_id = GetInternalVariableValue(spell_entity_id, 'increase_draw_4.target_wand_entity_id', 'value_int')
  if wand_entity_id == nil then
    wand_entity_id = EntityGetParent(spell_entity_id)
    AddNewInternalVariable(spell_entity_id, 'increase_draw_4.target_wand_entity_id', 'value_int', wand_entity_id)
  end
  ...
  local already_increased_actions_per_round = EntityHasTag(spell_entity_id, 'enabled_increase_draw_4')
